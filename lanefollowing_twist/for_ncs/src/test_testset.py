...
def evaluate_results(split):
    ...
    call(["./CaffeNetAnalysis/CaffeNetAnalysisMain",
          ...
          #os.path.join(os.path.abspath("../images/iros-2015-four-score/images/"), ""),    #for iros-2015 images
          "../caffe_data/deploy.prototxt",
          "../results/{0}/snapshots/solvertemplate_iter_10000.caffemodel".format(split),
          "../classid.txt",
