...
class ImageCreator():
    ...
    def __init__(self):
        ...
        f1 = open('joystick2/train.txt', 'w') # change "ele" to the folder name you created/
        f2 = open('joystick2/test.txt', 'w') 

        #---bag part---
        with rosbag.Bag('lanefollowing16.bag', 'r') as bag: #open first .bag
            print "lanefollowing16.bag"
            for topic,msg,t in bag.read_messages():
                ...
                if topic == "/alex1114/joy_mapper_node/car_cmd": #change ros_master name from aiplus1 to your duckiebot's name
                    ...
                    if self.t == 1:
                        ...
                        cv2.imwrite("joystick2/"+image_name, cv_image)
                        
                        if self.i == 9:
                            f2.write("joystick2/"+image_name+" "+str(self.omega)+" "+str(self.v)+"\n")
                            self.i = 0
                        else:                             
                            f1.write("joystick2/"+image_name+" "+str(self.omega)+" "+str(self.v)+"\n")
                            self.i += 1
