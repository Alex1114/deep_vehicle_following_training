...
class ImageCreator():
    ...
    def __init__(self):
        ...
        #---bag part---
        with rosbag.Bag('lanefollowing06.bag', 'r') as bag: #open first .bag
            print "lanefollowing06.bag"
            for topic,msg,t in bag.read_messages():
                ...
                if topic == "/alex1114/joy_mapper_node/car_cmd": #change ros_master name from aiplus1 to your duckiebot's name
                    ...
                    if self.t == 1:
                        ...
                        if self.i == 9:
                            f2.write("lanefollowing/"+image_name+" "+str(self.omega)+" "+str(self.v)+"\n")
                            self.i = 0
                        else:                             
                            f1.write("lanefollowing/"+image_name+" "+str(self.omega)+" "+str(self.v)+"\n")
                            self.i += 1
                        print "image crop:",self.n
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing07.bag', 'r') as bag: #open second .bag
            print "lanefollowing07.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    ...
                    if self.t == 1:
                        ...
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing08.bag', 'r') as bag: #open third .bag
            print "lanefollowing08.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    #print topic, msg.header.stamp
                    ...
                    if self.t == 1:
                        ...
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing09.bag', 'r') as bag: #open third .bag
            print "lanefollowing09.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    #print topic, msg.header.stamp
                    ...
                    if self.t == 1:
                        ...
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing10.bag', 'r') as bag: #open third .bag
            print "lanefollowing10.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    #print topic, msg.header.stamp
