...
class ImageCreator():
    ...
    def __init__(self):
        ...
        f1 = open('joystick/train.txt', 'w') # change "ele" to the folder name you created/
        f2 = open('joystick/test.txt', 'w') 

        #---bag part---
        with rosbag.Bag('lanefollowing11.bag', 'r') as bag: #open first .bag
            print "lanefollowing11.bag"
            for topic,msg,t in bag.read_messages():
                ...
                if topic == "/alex1114/joy_mapper_node/car_cmd": #change ros_master name from aiplus1 to your duckiebot's name
                    ...
                    if self.t == 1:
                        ...
                        cv2.imwrite("joystick/"+image_name, cv_image)
                        ...
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing12.bag', 'r') as bag: #open second .bag
            print "lanefollowing12.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    ...
                    if self.t == 1:
                        ...
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing13.bag', 'r') as bag: #open third .bag
            print "lanefollowing13.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    #print topic, msg.header.stamp
                    ...
                    if self.t == 1:
                        ...
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing14.bag', 'r') as bag: #open third .bag
            print "lanefollowing14.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    #print topic, msg.header.stamp
                    ...
                    if self.t == 1:
                        ...
                        self.n += 1
                        self.t = 0
        with rosbag.Bag('lanefollowing15.bag', 'r') as bag: #open third .bag
            print "lanefollowing15.bag"
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/alex1114/joy_mapper_node/car_cmd":
                    #print topic, msg.header.stamp
